...
def createTopLevel(galaxy_status, workflowDict):
    # BCO ID
...
def createProvenanceDomain(inputBCODict, galaxy_status, workflowDict):
    ...
    while True:
        ...
        prov_contributor_contribution = input("Input contributor contributions seperated by a ',' : ")
...
def createIODomain(inputBCODict, galaxy_status, workflowDict):
    if galaxy_status == False:
        ...
        inputBCODict['io_domain'] = workflowDict['io_domain']
        return inputBCODict
...
def main():
    ...
    topLevelList = createTopLevel(galaxy_status, workflowDict)
